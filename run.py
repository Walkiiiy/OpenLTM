...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_col', type=str, default='y_delta_next_min', help='target column for LoginIntervalUser')
    ...
    parser.add_argument('--use_cpu', action='store_true', help='force CPU', default=False)
