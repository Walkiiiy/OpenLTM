from data_provider.data_loader import UnivariateDatasetBenchmark, MultivariateDatasetBenchmark, Global_Temp, Global_Wind, Dataset_ERA5_Pretrain, Dataset_ERA5_Pretrain_Test, UTSD, UTSD_Npy, LoginIntervalUser
...
data_dict = {
    ...
    'Utsd': UTSD,
    'Utsd_Npy': UTSD_Npy,
    'LoginIntervalUser': LoginIntervalUser,
}
...
def data_provider(args, flag):
    ...
    if args.data == 'LoginIntervalUser':
        data_set = Data(
